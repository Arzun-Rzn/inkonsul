...
const modules = [
  ...
  { id: '02', title: 'Talent Acquisition and Development', description: 'Advanced strategies for sourcing, identifying, and nurturing high-potential talent within competitive markets.', icon: '👥' },
  { id: '03', title: 'HR Operations Management', description: 'Streamlining core HR processes to drive organizational efficiency and employee experience excellence.', icon: '⚙️' },
  { id: '04', title: 'Payroll Management', description: 'Comprehensive understanding of compensation structures, benefits administration, and payroll systems.', icon: '💵' },
  ...
  { id: '06', title: 'Labour Law Statutory Compliances', description: 'Navigating complex legal frameworks and ensuring absolute adherence to contemporary labour regulations.', icon: '⚖️' },
  ...
  { id: '08', title: 'AI and Automation in HR', description: 'Harnessing artificial intelligence and robotic process automation to redefine the future of human resources.', icon: '🤖' },
